...
const IMG_BASE = (() => {
  ...
  // y si estamos en subcarpeta /Esqueleto/ o en raíz
  if (path.includes('/Esqueleto/')) return '../img/';
  return 'img/';
})();
...
const catalog = [
  {
    ...
    price: 220,
    status: "available",
    img: `${IMG_BASE}pensamiento-positivo.png`,
  ...
  },
  {
    ...
    price: 350,
    status: "available",
    img: `${IMG_BASE}habitos-completa.png`,
  ...
  },
  {
    ...
    price: 250,
    status: "available",
    img: `${IMG_BASE}secretos-mente-millonaria.png`,
  ...
  },
  {
    ...
    price: 300,
    status: "available",
    img: `${IMG_BASE}inteligencia-emocional.png`,
  ...
  },
  {
    ...
    price: 150,
    status: "available",
    img: `${IMG_BASE}hombre-babilonia.png`,
